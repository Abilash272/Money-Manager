      ...
      <View className="w-full">
        ...
        <View className="flex-row w-full py-2">
          <TouchableOpacity onPress={() => setSelectedOption('Daily')}
            className={`w-1/2 flex items-center ${selectedOption === 'Daily' ? 'border-b-2 border-[#d66760]' : 'border-b-2 border-[#9b9b9b]'
              }`
            }>
          ...
          <TouchableOpacity onPress={() => setSelectedOption('Monthly')}
            className={`w-1/2 flex items-center ${selectedOption === 'Monthly' ? 'border-b-2 border-[#d66760]' : 'border-b-2 border-[#9b9b9b]'
              }`
            }>
            <Text className="text-white text-base pr-3">
              Monthly
